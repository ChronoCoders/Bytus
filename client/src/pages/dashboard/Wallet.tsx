...
import { DashboardActions, AddAssetButton } from "@/components/dashboard/Actions";
      ...
      <div className="space-y-8">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground mt-1">Manage your fiat and crypto assets.</p>
          </div>
          <AddAssetButton />
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid gap-4">
            {assets.map((asset) => (
              <Card key={asset.symbol} className="hover:shadow-md transition-shadow cursor-pointer border-border">
                <CardContent className="flex items-center justify-between p-6">
                  ...
                  <div className="text-right">
                    ...
                    <p className={cn("text-sm flex items-center justify-end gap-1", asset.isPositive === undefined ? "text-muted-foreground" : asset.isPositive ? "text-green-600" : "text-destructive")}>
