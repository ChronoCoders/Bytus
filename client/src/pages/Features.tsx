...
import { ArrowLeft, Check, Shield, Wallet, Lock, Store, Globe, RefreshCw } from "lucide-react";
...
export default function FeaturesPage() {
  ...
  const personalFeatures = [
    {
      ...
      id: "personal-wallet",
      description: "Experience the freedom of managing all your assets in one place. Our wallet supports multiple FIAT currencies (USD, EUR, GBP) alongside major cryptocurrencies.",
      icon: Wallet,
      details: [
    ...
    },
    {
      ...
      id: "card",
      description: "Spend your crypto as easily as cash. The Bytus card automatically converts your digital assets to local currency at the point of sale.",
      icon: Globe,
      details: [
        "Accepted worldwide",
    ...
    },
    {
      ...
      id: "exchange",
      description: "Swap between currencies with zero friction. Our smart routing engine ensures you get the best market rates without hidden markups.",
      icon: RefreshCw,
      details: [
  ...
  const businessFeatures = [
    ...
    },
    {
      ...
      description: "Gain deep insights into your financial operations. Track revenue, manage payroll, and generate tax reports from a single command center.",
      icon: Lock,
      details: [
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground leading-relaxed max-w-2xl mx-auto">
              Whether you're an individual looking for financial freedom or a business seeking efficiency, 
              Bytus provides the tools you need to succeed in the digital economy.
            </p>
          </motion.div>
          ...
          <div className="space-y-32">
            ...
            <section id="personal" className="scroll-mt-32">
              <div className="flex items-center gap-4 mb-12">
                ...
                <h2 className="text-2xl font-bold text-muted-foreground uppercase tracking-widest">Personal Banking</h2>
                <div className="h-px bg-border flex-1" />
              </div>
              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center relative z-10">
                <div className="text-left">
                  ...
                  <p className="text-primary-foreground/80 mb-8 text-lg leading-relaxed">
                    Download our top-rated mobile app and manage your crypto and fiat assets 
                    from anywhere in the world. Real-time notifications, instant transfers, 
                    and total control at your fingertips.
                  </p>
