  ...
  const incidents = [
    {
      ...
      updates: [
        {
          time: "14:30 UTC",
          message: "All pending settlements have been processed.",
        },
        {
          time: "10:15 UTC",
          message: "We are investigating reports of delayed SEPA transfers.",
        },
      ],
    },
    {
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                {incidents.map((incident, i) => (
                  <div
                    key={i}
                    className="border-l-2 border-border pl-8 relative pb-8 last:pb-0"
                  >
