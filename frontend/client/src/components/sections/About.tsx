        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-16">
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                Enterprises face hurdles with wallet management, security keys,
                and regulatory uncertainty. Traditional banks are hesitant to
          ...
          >
            ...
            <p className="text-center text-muted-foreground mb-8">
              Bytus is enterprise infrastructure, not consumer fintech. We focus
              exclusively on B2B payment and treasury solutions.
            </p>
              ...
              <div className="flex gap-3">
                ...
                <p className="text-muted-foreground">
                  <span className="font-semibold text-foreground">
                    Not a Consumer Neo-Bank:
                  </span>{" "}
                  We don't compete with Revolut or Coinbase retail products.
                  Bytus serves businesses, not individual consumers.
                </p>
              </div>
              <div className="flex gap-3">
                <div className="w-1.5 h-1.5 rounded-full bg-destructive mt-2.5 shrink-0" />
                <p className="text-muted-foreground">
                  <span className="font-semibold text-foreground">
                    Not a Retail Crypto Wallet:
                  </span>{" "}
                  No mobile app for personal spending. Our infrastructure is
                  designed for merchants and enterprises processing high
                  volumes.
                </p>
              </div>
              <div className="flex gap-3">
                ...
                <p className="text-muted-foreground">
                  ...
                  We focus on regulated banking operations with predictable
                  settlement, not experimental decentralized finance.
                </p>
              </div>
              <div className="flex gap-3">
                <div className="w-1.5 h-1.5 rounded-full bg-destructive mt-2.5 shrink-0" />
                <p className="text-muted-foreground">
                  <span className="font-semibold text-foreground">
                    Not a Speculative Token Project:
                  </span>{" "}
                  BUS is a mandatory operational token for network access, not
                  an investment asset or governance token for speculation.
                </p>
              </div>
              <div className="flex gap-3">
                <div className="w-1.5 h-1.5 rounded-full bg-destructive mt-2.5 shrink-0" />
                <p className="text-muted-foreground">
                  ...
                  We use proven, audited collateralization methods through
                  regulated fiat partners. No algorithmic experiments.
                </p>
              </div>
              <div className="flex gap-3">
                <div className="w-1.5 h-1.5 rounded-full bg-destructive mt-2.5 shrink-0" />
                <p className="text-muted-foreground">
                  ...
                  We don't build Venmo/Cash App alternatives. Bytus provides B2B
                  infrastructure that payment apps could integrate.
                </p>
              </div>
            </div>
            <p className="text-center text-muted-foreground mt-8 font-medium">
              Bytus is payment infrastructure for businesses that need crypto
              capabilities without crypto complexity.
            </p>
          </motion.div>
