    ...
    <footer className="bg-primary text-primary-foreground pt-20 pb-10">
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-primary-foreground/80 leading-relaxed text-sm">
              Enterprise-grade cryptocurrency payment infrastructure for modern
              businesses.
            </p>
          </div>
            ...
            <ul className="space-y-4 text-primary-foreground/80">
              ...
              <li>
                <Link
                  ...
                  className="hover:text-primary-foreground transition-colors cursor-pointer"
                  onClick={(e) => handleLinkClick(e, "/features#treasury")}
                >
                  Treasury Management
                </Link>
              </li>
              <li>
                <Link
                  ...
                  className="hover:text-primary-foreground transition-colors cursor-pointer"
                  onClick={(e) => handleLinkClick(e, "/features#compliance")}
                >
                  Compliance
                </Link>
              </li>
              <li>
                <Link
                  href="/features#api"
                  className="hover:text-primary-foreground transition-colors cursor-pointer"
                  onClick={(e) => handleLinkClick(e, "/features#api")}
                >
                  Developer API
                </Link>
              </li>
        ...
        <div className="pt-8 border-t border-primary-foreground/10 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-primary-foreground/60">
          <p>
            &copy; {new Date().getFullYear()} Distributed Systems Labs, LLC. All
            rights reserved.
          </p>
